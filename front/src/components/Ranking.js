                  ...
                  <Fragment>
                    {this.state.query === ""
                      ? this.state.rankingList
                          .sort(
                            (a, b) =>
                              b[this.state.currentGame] -
                              a[this.state.currentGame]
                          )
                          .slice(0, 10)
                          .map((score, index) => (
                            <tr key={index}>
                      ...
                      : this.state.rankingList
                          .filter(score =>
                            score.username.includes(this.state.query)
                          )
                          .slice(0, 10)
                          .map((score, index) => (
                            <tr key={index}>
